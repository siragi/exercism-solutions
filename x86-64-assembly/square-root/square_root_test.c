...
{
    for (size_t i = 1; i <= 278; i++)
    {
        TEST_ASSERT_EQUAL_INT(i, square_root(i * i));
    }
}

void test_root_of_77841(void)
{
    TEST_ASSERT_EQUAL_INT(279, square_root(77841));
}

void test_root_of_2147395600(void)
{
...
int main(void)
{
    ...
    RUN_TEST(test_root_of_77841);
    RUN_TEST(test_root_of_2147395600);
    RUN_TEST(test_roots);
    return UNITY_END();
}
